...
bedClip NP4s-10K-01-hg19_INTER.bed hg19.chrom.sizes UD4s-10K-01-hg19_INTER_CLIP.bed
#hg38
...
track type=bigInteract interactUp=true name="interact Example Three" description="A bigInteract file" useScore=on visibility=full bigDataUrl=https://bioshare.bioinformatics.ucdavis.edu/bioshare/download/hbl76b4wa1i6dvm/NP4s-10K-01-hg19_INTER.bb
