...
files <- dir(path = "/Users/fsociety/Library/CloudStorage/OneDrive-UCDavis/Documents/Dovetailoutput/Redos",pattern = ".bed$", recursive=TRUE)
...
#load data from fithichip
  filename= glue("/Users/fsociety/Library/CloudStorage/OneDrive-UCDavis/Documents/Dovetailoutput/Redos/{f}")
...
#Writes image as png with desired dimensions and uses file currently loaded for naming image
  png(file=glue("/Users/fsociety/Library/CloudStorage/OneDrive-UCDavis/Documents/Dovetailoutput/Redos/{new.file}.png"),width = 1043,height = 516)
#Plot arcs with arc heights based on contact frequency
  ...
  labelplot("                  5K bins FDR: 0.01 chr15:25120000-25950000", new.file, titlecex=2, titleline="1.7")
  dev.off()
}
