...
# Data for the Y-axis
treatment_groups <- c('HEK293T', 'Undifferentiated LUHMES', '7 Day Differentiated LUHMES', 'Human Neuronal Cortex')
...
data$Treatment_Groups <- factor(data$Treatment_Groups, levels = c('HEK293T', 'Undifferentiated LUHMES', '7 Day Differentiated LUHMES', 'Human Neuronal Cortex'))

# Set custom colors
colors <- c('HEK293T' = 'gray90', 
            'Undifferentiated LUHMES' = 'gray90', 
            '7 Day Differentiated LUHMES' = 'gray55', 
            'Human Neuronal Cortex' = 'gray90')
...
ggplot(data, aes(x = Treatment_Groups, y = Expression, fill = Treatment_Groups)) +
  ...
  geom_segment(aes(x = -Inf, xend = -Inf, y = -30, yend = 16540), color = "gray", size = 2) +
